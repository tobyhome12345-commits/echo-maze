...
Until you walk into the room and do what twelve levels have taught you to do. **The next ripple you send** reaches it, and the wall answers. (If you send nothing for about seven seconds, you send one anyway — a flinch, not a decision. It is not counted as one of your ripples.) From that moment you have no controls, and what follows takes about three seconds:
